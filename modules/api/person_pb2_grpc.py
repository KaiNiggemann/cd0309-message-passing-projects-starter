...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                response_deserializer=person__pb2.PersonResponseMessage.FromString,
...
def add_PersonServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=person__pb2.PersonResponseMessage.SerializeToString,
            ),
    }
...
class PersonService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            person__pb2.PersonResponseMessage.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
